...
В данном разделе приведен пример формирования заголовков *Date* и *Authentication* с использованием языка программирования Java (>=1.8). Приведенный фрагмент кода всего-лишь пример и не предназначен для использования в production решениях "как есть". Вы можете свободно копировать/изменять/использовать данный фрагмент код без всяких гарантий работоспособности с нашей стороны (на свой страх и риск :)
