...
public class NaiveHmacSigner {
    ...
    static final DateTimeFormatter DATEFORMAT = DateTimeFormatter.RFC_1123_DATE_TIME;

    public synchronized Map<String, String> newSignature(String method, String uri) {
        ...
        final String authHeaderValue =
                String.format("hmac %s:%s:%s", this.username, nonce, signBase64);
    ...
    public static NaiveHmacSigner newSigner(String username, byte[] secret)
