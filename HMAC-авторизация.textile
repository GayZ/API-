...
В данном разделе приведен пример формирования заголовков *Date* и *Authentication* с использованием языка программирования Java (>=1.8). Приведенный фрагмент кода всего-лишь пример и не предназначен для использования в production решениях. Вы можете свободно копировать/изменять/использовать любой фрагмент кода без всяких гарантий работоспособности с нашей стороны (на свой страх и риск :)
